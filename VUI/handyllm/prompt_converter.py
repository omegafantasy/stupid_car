...
class PromptConverter:
    ...
    def rawfile2chat(self, raw_prompt_path: str, suffix=""):
    ...
    def chat_replace_variables_from_dict(self, chat, raw_map, inplace=False):
        variable_map = {'%' + K + '%':raw_map[K] for K in raw_map}
        return self.chat_replace_variables(chat, variable_map, inplace)
